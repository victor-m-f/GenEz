...
{
    public class PersonNamesController : ApiControllerBase
    {
        ...
        [AllowAnonymous]
        [HttpGet]
        public async Task<ActionResult<ApiResponseWithResult<IEnumerable<PersonNameDto>>>> GetAll()
        {
            return Respond(await _characterQueryHandler.GetAllPersonNamesAsync());
        }

        [AllowAnonymous]
        [HttpPost]
        public async Task<ActionResult<ApiResponse>> Create(CreatePersonNameCommand command)
        {
