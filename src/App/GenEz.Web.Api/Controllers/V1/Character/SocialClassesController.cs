...
{
    public class SocialClassesController : ApiControllerBase
    {
        private readonly ICharacterQueryHandler _characterQueryHandler;

        public SocialClassesController(
            ILogger<SocialClassesController> logger,
        ...
        [AllowAnonymous]
        [HttpGet]
        public async Task<ActionResult<ApiResponseWithResult<IEnumerable<SocialClassDto>>>> GetAll()
        {
            return Respond(await _characterQueryHandler.GetAllSocialClassesAsync());
        }
    }
}
